...
echo "Fixing Wazuh Dashboard config..."
docker exec clab-dmz-project-sun-wazuh-dashboard sed -i 's|url: https://.*|url: https://172.20.20.8|' /usr/share/wazuh-dashboard/data/wazuh/config/wazuh.yml
